...
\begin{document}
	...
	\lstinputlisting[linerange={opened-log\ close}]{../stata/stern_assignment_q2.log}
	...
	\lstinputlisting[linerange={opened-log\ close}]{../stata/stern_assignment_q3.log}
	
	 \begin{figure}
      %\includegraphics[width=12cm]{../stata/graph_scan-1.png}
	...
	\lstinputlisting[linerange={opened-log\ close}]{../stata/stern_assignment_q5.log}
	
\fvset{fontfamily=tt,fontsize=\small,frame=single,formatcom=\color{blue},label=\emph{Interactive Stata example}}
\verbatiminput{../stata/stern_assignment_q5.log}

\begin{CVerbatim}
\input{../stata/stern_assignment_q5.log}
\end{CVerbatim}
